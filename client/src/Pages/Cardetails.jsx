        ...
        <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
           ...
           className='lg:col-span-2'>
              ...
              transition={{duration:0.5,delay:0.2}}>
                  ...
                  <div className='grid grid-cols-2 sm:grid-cols-4 gap-4'>
                     {[
                      {icon:assets.users_icon_icon,text:`${car.seating_capacity} Seats`},
                  ...
                  <div>
                     ...
                     <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                      {
                        ["360 Camara","Bluetooth" ,"GPS" ,"Heated Seats","Rear View Mirror"].map((item)=>(
          ...
          <motion.form
           ...
           onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
            ...
            <button className='w-full bg-primary hover:bg-primary-dull transition-all py-3 font-medium text-white
            rounded-xl cursor-pointer'>Book Now</button>
